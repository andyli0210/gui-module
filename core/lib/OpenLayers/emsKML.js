 ...
 */
OpenLayers.Format.emsKML = OpenLayers.Class(OpenLayers.Format.XML, {
    ...
    readers: {
        ...
        "gx": {
            ...
            "coord": function(node, container) {
                ...
                var point = new OpenLayers.Geometry.Point(coords[0], EMS.Util.latToSGP4(coords[1]));
                if (coords.length > 2) {
    ...
    parseGeometry: {
        ...
        point: function(node) {
            ...
            if(coords.length > 1) {
                ...
                point = new OpenLayers.Geometry.Point(coords[0], EMS.Util.latToSGP4(coords[1]),
                                                      coords[2]);
            } else {
