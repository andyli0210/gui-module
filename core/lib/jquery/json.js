/*
    ...
    This file has been superceded by http://www.JSON2.org/json2.js
    ...
    This file adds these methods to JavaScript:
        ...
        object.toJSON2String(whitelist)
            This method produce a JSON2 text from a JavaScript value.
            It must not contain any cyclical references. Illegal values
            will be excluded.

            The default conversion for dates is to an ISO string. You can
            add a toJSON2String method to any date object to get a different
            representation.
        ...
        string.parseJSON2(filter)
            This method parses a JSON2 text to produce an object or
            ...
            myData = text.parseJSON2(function (key, value) {
...
/*members "", "\b", "\t", "\n", "\f", "\r", "\"", JSON2, "\\", apply,
    ...
    lastIndex, length, parse, parseJSON2, prototype, push, replace, slice,
    stringify, test, toJSON2, toJSON2String, toString, valueOf
*/
...
// These forms are obsolete. It is recommended that JSON2.stringify and
// JSON2.parse be used instead.

    if (!Object.prototype.toJSON2String) {
        Object.prototype.toJSON2String = function (filter) {
            return JSON2.stringify(this, filter);
        };
        Object.prototype.parseJSON2 = function (filter) {
            return JSON2.parse(this, filter);
        };
    }
}());
