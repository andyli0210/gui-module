...
//    }
    ...
    function onMouseClickMatch(match, options) {
        ...
        if (match) {
            ...
            domain.latitude = lat.toFixed(6);
            domain.longtitude = lon.toFixed(6);
        } else {
    ...
    function showLocationConfirmPopup(addressDomain, marker, x,y) {
        ...
        content.dialog({
            ...
            buttons: {
                'OK': function(e) {
                    if (marker.oriLonlat != marker.lonlat) {
                        marker.oriLonlat = marker.lonlat;
                ...
                'Cancel': function() {
                    marker.lonlat = marker.oriLonlat;
